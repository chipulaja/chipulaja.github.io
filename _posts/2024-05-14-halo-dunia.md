...
Ini adalah halo dunia dari chipulaja di jekyll. Tidak ada yang spesial di sini, di sini hanya berisi halo dunia dan beberapa contoh format markdown untuk jaga jaga kalo lupa. misal cara membuat diagram dengan mermaid dan contoh contoh yang lain nya yang di ambil dari sumber nya langsung [jekyll-theme-chirpy](https://github.com/cotes2020/jekyll-theme-chirpy/) .
...
```mermaid
graph TD
    A[Inisiasi Rencana] --> B[Analisis Kebutuhan]
    B --> C[Perencanaan Detail]
    C --> D[Persiapan Sumber Daya]
    D --> E[Penerapan Rencana]
    E --> F[Monitoring & Evaluasi]
    F --> G{Rencana Berhasil?}
    G --> |Ya| H[Penyelesaian]
    G --> |Tidak| I[Penyesuaian & Revisi]
    I --> D

    style A fill:#30412d,stroke:#333,stroke-width:4px
    style H fill:#664747,stroke:#333,stroke-width:4px
    style I fill:#4c2d4c,stroke:#333,stroke-width:4px
```
